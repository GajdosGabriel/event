...
return [
    ...
    'account' => [
        ...
        'remote_write_blocked' => 'Schreibzugriffe auf eine entfernte Account-Instanz sind aus dieser Umgebung gesperrt, damit im Echtbetrieb keine Testfirmen entstehen. Wenn es wirklich gewollt ist, setzen Sie in der .env ACCOUNT_ALLOW_REMOTE_WRITES=true.',
    ],
