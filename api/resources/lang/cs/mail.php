...
return [
    ...
    'verification' => [
        ...
        'subject_event' => 'Ověřte e-mail a dokončete přihlášení na :event',
        'intro_event' => 'Děkujeme, že se přihlašujete na akci **„:event"**. Nejprve prosím ověřte svou e-mailovou adresu.',
        'event_note' => 'Místo na akci **„:event"** si zarezervujete až po ověření e-mailu — hned potom vám pošleme e-mail s odkazem na rezervaci.',
        'action_event' => 'Ověřit e-mail',
    ],
    ...
    'event_signup_organizer' => [
        ...
        'action' => 'Zobrazit seznam přihlášených',
        'claim_intro' => 'Akci jsme zveřejnili na portálu event.hlascirkvi.sk pod kanálem **„:canal"**, který zatím nikdo nespravuje. Zpráva vám přišla na kontakt uvedený u akce.',
        'claim_benefits' => 'Převzetí kanálu je zdarma. Uvidíte seznam přihlášených a jejich kontakty, budete moci upravovat tuto akci, přidávat další, nastavit kapacitu a na vstupu načítat QR kódy.',
        'claim_action' => 'Převzít kanál a zobrazit přihlášené',
        'claim_ignore' => 'Pokud nejste organizátorem této akce, tento e-mail klidně ignorujte.',
    ],
    'event_signup_admin' => [
        'subject' => 'Přihlášení na akci: :event',
        'intro' => '**:name** (:email) se přihlásil(a) na akci **„:event"**.',
        'status' => [
            'reserved' => 'Výsledek: místo rezervováno, vstupenka vystavena.',
            'interest' => 'Výsledek: jen zájem (rezervace vypnutá, jen placené vstupenky nebo plno).',
            'already_registered' => 'Výsledek: už byl(a) přihlášen(a).',
            'closed' => 'Výsledek: přihlašování je uzavřeno.',
        ],
        'organizer' => [
            'owner' => 'Organizátor dostal zprávu: :email',
            'invitation' => 'Kanál nikdo nespravuje — pozvánka k převzetí odešla na :email.',
            'none' => 'Organizátora se nepodařilo oslovit — u akce ani kanálu chybí e-mail. Kontaktujte ho ručně.',
        ],
        'event_link' => 'Akce: :url',
        'action' => 'Seznam přihlášených',
    ],
    'event_reservation_invite' => [
        'subject' => 'Účet je ověřen — zarezervujte si místo na :event',
        'intro' => 'Děkujeme, váš e-mail je ověřen a účet je připraven.',
        'next' => 'Nyní si můžete zarezervovat místo na akci **„:event"** — stačí se přihlásit a potvrdit jedním kliknutím. Vstupenku s QR kódem vám pošleme e-mailem.',
        'action' => 'Rezervovat místo',
        'outro' => 'Rezervace je zdarma. Organizátor dostane zprávu, že přijdete.',
    ],
    'event_interest' => [
        'subject' => 'Váš zájem o :event',
