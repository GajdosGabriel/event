...
return [
    ...
    'verification' => [
        ...
        'subject_event' => 'Verify your email to finish signing up for :event',
        'intro_event' => 'Thank you for signing up for **":event"**. Please verify your email address first.',
        'event_note' => 'You can reserve your place at **":event"** once you verify your email — right after that we will send you a link to reserve it.',
        'action_event' => 'Verify email',
    ],
    ...
    'event_signup_organizer' => [
        ...
        'contact' => 'Attendee contact: :email',
        'action' => 'View attendee list',
        'claim_intro' => 'The event is listed on event.hlascirkvi.sk under the channel **":canal"**, which nobody manages yet. This message was sent to the contact given for the event.',
        'claim_benefits' => 'Taking over the channel is free. You will see the attendee list with contacts, can edit this event, add more, set capacity and scan QR codes at the entrance.',
        'claim_action' => 'Take over the channel and view attendees',
        'claim_ignore' => 'If you are not the organiser of this event, you can safely ignore this email.',
    ],

    'event_signup_admin' => [
        'subject' => 'Event sign-up: :event',
        'intro' => '**:name** (:email) signed up for **":event"**.',
        'status' => [
            'reserved' => 'Result: place reserved, ticket issued.',
            'interest' => 'Result: interest only (reservations off, paid tickets only or full).',
            'already_registered' => 'Result: was already registered.',
            'closed' => 'Result: registration is closed.',
        ],
        'organizer' => [
            'owner' => 'Organiser notified: :email',
            'invitation' => 'Nobody manages the channel — a takeover invitation was sent to :email.',
            'none' => 'The organiser could not be reached — no email on the event or channel. Please contact them manually.',
        ],
    ...
    'event_reservation_invite' => [
        'subject' => 'Account verified — reserve your place at :event',
        'intro' => 'Thank you, your email is verified and your account is ready.',
        'next' => 'You can now reserve your place at **":event"** — just log in and confirm with one click. We will email you a ticket with a QR code.',
        'action' => 'Reserve a place',
        'outro' => 'The reservation is free. The organiser will be notified that you are coming.',
    ],

    'event_interest' => [
        'subject' => 'Your interest in :event',
