...
return [
    ...
    */
    ...
    'attributes' => [
        ...
        'file_type'          => 'file type',
        'file_disk'          => 'file disk',
        'make_primary_file'  => 'set as primary file',
        ...
        'title'              => 'name',
        'village_id'         => 'municipality',
        'person'             => 'subject type',
        'description'        => 'description',
        'phone'              => 'phone',

        // Billing block forwarded to Account
        'account.name'              => 'company name',
        'account.legal_name'        => 'legal name',
        'account.legal_form'        => 'legal form',
        'account.ico'               => 'company number',
        'account.dic'               => 'tax number',
        'account.ic_dph'            => 'VAT number',
        'account.vat_mode'          => 'VAT status',
        'account.oss_registered'    => 'OSS registration',
        'account.register_court'    => 'register court',
        'account.register_section'  => 'section',
        'account.register_insert'   => 'insert number',
        'account.established_at'    => 'establishment date',
        'account.street'            => 'street',
        'account.street_no'         => 'street number',
        'account.city'              => 'city',
        'account.postal_code'       => 'postal code',
        'account.region'            => 'region',
        'account.country'           => 'country',
        'account.email'             => 'e-mail',
        'account.billing_email'     => 'billing e-mail',
        'account.phone'             => 'phone',
        ...
        'account.payment_terms_days' => 'payment terms',
        'account.payment_method'    => 'payment method',
        'account.invoice_language'  => 'invoice language',
        'account.invoice_delivery'  => 'invoice delivery',
        'account.supplier_number'   => 'our number at the customer',
