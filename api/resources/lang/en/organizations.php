...
return [
    ...
    'account' => [
        ...
        'remote_write_blocked' => 'Writing to a remote Account instance is blocked from this environment so that test records do not end up in the live company registry. If you really want it, set ACCOUNT_ALLOW_REMOTE_WRITES=true in .env.',
    ],
