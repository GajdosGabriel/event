 ...
 *
 * Zapína sa jedine cez SENTRY_LARAVEL_DSN v .env — bez neho je SDK ticho,
 * takže lokálne ani v testoch netreba nič vypínať. Zapojenie do hlásenia chýb
 * je v bootstrap/app.php (`Integration::handles()`).
 *
 * Výkonnostné trasovanie (traces_sample_rate) je zámerne vypnuté: zaujímajú nás
 * chyby, nie profily, a každá vzorka sa počíta do kvóty.
 *
 * `send_default_pii` ostáva vypnuté — do Sentry nemajú tiecť e-maily a IP
 * adries návštevníkov.
 *
...
return [
    ...
    'ignore_transactions' => [
        ...
        '/up',
        // Webcron búcha na tento endpoint každú minútu.
        '/cron/schedule-run',
    ],
