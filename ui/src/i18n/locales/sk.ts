...
const sk = {
  ...
  public: {
    ...
    questions: {
      ...
      // Súkromný vstup: otázka, ktorá sa na plátno nehodí, a počas akcie
      // podnet organizátorovi. Ten istý formulár, iné meno — lebo sa aj inak
      // používa (App\Enums\QuestionVisibility).
      leadLiveFeedback: 'Podujatie práve prebieha. Otázky idú prednášajúcemu — a čo naň nepatrí (zima, zvuk, poriadok), pošlite organizátorovi ako podnet.',
      audience: 'Komu to ide',
      publicAsk: 'Verejná otázka',
      publicAskHint: 'Uvidia ju aj ostatní — aj odpoveď organizátora.',
      privateAsk: 'Súkromná otázka',
      privateAskHint: 'Uvidí ju len organizátor. Odpoveď vám príde e-mailom.',
      publicLive: 'Otázka pre prednášajúceho',
      publicLiveHint: 'Môže sa objaviť na plátne v sále.',
      feedbackAsk: 'Podnet z publika',
      feedbackAskHint: 'Napríklad zima v sále alebo slabý zvuk. Uvidí to len organizátor.',
      privateLocked: 'Podnet počas akcie môže poslať len prihlásený účastník.',
      yourFeedback: 'Váš podnet',
      feedbackPlaceholder: 'Napríklad: V sále je veľká zima.',
      submitFeedback: 'Odoslať podnet',
      notifyPrivate: 'Odpoveď vám pošleme e-mailom — inde ju neuvidíte.',
      sentPrivateTitle: 'Odoslané organizátorovi',
      sentPrivateLead: 'Uvidí to len organizátor. Ak odpovie, príde vám e-mail.',
    ...
    event: {
      ...
      endedCta: 'Nadchádzajúce podujatia',
    ...
    seo: {
      ...
      archiveHeading: 'Archív podujatí',
      archiveTitle: 'Archív podujatí',
      archiveDescription: 'Podujatia, ktoré sa už konali — od najnovších.',
    },
  },
  ...
  tickets: {
    ...
    // Stavy objednávky a platby vo filtri zoznamu prihlásených. Popisky
    // v tabuľke posiela API v jazyku používateľa, tu sú pre výber vo filtri.
    statuses: {
      confirmed: 'Potvrdené',
    ...
    // Bočný panel zoznamu prihlásených.
    stats: {
      arrived: 'Prešlo dverami',
      seatsUnit: 'vstupeniek',
      remaining: 'čaká {n}',
      confirmed: 'Potvrdené',
      reserved: 'Rezervácie',
      cancelled: 'Zrušené',
      payments: 'Platby',
      paid: 'Uhradené',
      awaitingPayment: 'Čaká na platbu ({n})',
      types: 'Typy lístkov',
      typeArrived: 'prišlo {n}',
      typeWaitlisted: 'náhradníci: {n}',
      openScanner: 'Otvoriť skener pri vchode',
    },
    request: {
    ...
    attendees: {
      ...
      markPaid: 'Označiť ako uhradené',
      markedPaid: 'Platba označená ako uhradená.',
      restoreOrder: 'Obnoviť',
      restoreOrderConfirm: 'Obnoviť zrušenú objednávku pre {name}? Pošleme mu e-mail s vstupenkami.',
      deleteOrder: 'Vymazať zo zoznamu',
      deleteOrderConfirm: 'Vymazať zrušenú objednávku pre {name} zo zoznamu? Účastníkovi sa nič neposiela.',
      restoreSeat: 'Obnoviť',
      restoreSeatConfirm: 'Obnoviť túto zrušenú vstupenku? Objednávateľovi pošleme e-mail.',
      deleteSeat: 'Vymazať',
      deleteSeatConfirm: 'Vymazať túto zrušenú vstupenku zo zoznamu?',
      restored: 'Obnovené — e-mail odoslaný.',
      deleted: 'Vymazané zo zoznamu.',
      cancelDone: 'Zrušené.',
  ...
  questions: {
    ...
    dashboard: {
      ...
      settings: {
        ...
        allowPrivate: 'Prijímať súkromné otázky a podnety',
        allowPrivateHint: 'Otázka len pre vás — a počas akcie podnet („v sále je zima"). Nikde sa nezverejní a odpoveď pošleme pisateľovi e-mailom.',
      ...
      moderation: {
        ...
        private: 'Súkromné',
        privateBadge: 'Súkromná',
        feedbackBadge: 'Podnet z akcie',
        privateNotify: 'Odpoveď pošleme pisateľovi e-mailom.',
        privateNotified: 'Odpoveď sme pisateľovi poslali e-mailom a adresu sme zmazali — ďalšiu úpravu odpovede sa už nedozvie.',
        markHandled: 'Označiť za vybavené',
  ...
  systemLog: {
    ...
    intro: 'Čo komu odišlo a čo nie, prihlásenia, importy, cron a výpadky služieb.',
    retention: 'Bežné záznamy sa mažú po {days} dňoch, varovania a chyby po {errorDays}.',
    loading: 'Načítavam…',
    loadFailed: 'Denník sa nepodarilo načítať.',
    empty: 'Žiadne udalosti.',
    events: 'Udalosti',
    total: '{n} vo výbere',
    details: 'Podrobnosti',
    byRecipient: 'Všetky udalosti tohto príjemcu',
    card: {
      sent: 'Odoslané maily',
      failed: 'Neodoslané maily',
      errors: 'Chyby',
      logins: 'Prihlásenia',
      authFailed: 'Neúspešné prihlásenia',
      day: 'za 24 hodín',
      week: 'za 24 h · {n} za 7 dní',
    },
    filter: {
      search: 'Hľadať',
      searchPlaceholder: 'e-mail alebo text',
      channel: 'Oblasť',
      level: 'Závažnosť',
      status: 'Stav',
      from: 'Od',
    ...
    channel: {
      ...
      queue: 'Fronta',
      scheduler: 'Plánovač',
      import: 'Import podujatí',
      openai: 'OpenAI',
    },
  },
  aiUsage: {
    title: 'Spotreba AI',
    intro: 'Koľko tokenov a peňazí berú AI funkcie — detekcia podujatí z textu a plagátov, prepis a úprava textov, štítky, miesta a kontrola obsahu. Každé volanie OpenAI sa zapisuje, nič sa tu nevypína.',
    loading: 'Načítavam…',
    loadFailed: 'Spotrebu sa nepodarilo načítať.',
    empty: 'Zatiaľ žiadne volania.',
    days: '{n} dní',
    ...
    error: 'chyba',
    byDay: 'Cena po dňoch',
    byFeature: 'Podľa operácie',
    byCanal: 'Podľa kanála',
    byCanalNote: 'Kanál je známy pri štítkovaní, kontrole obsahu a AI detektore importovaných podujatí.',
    bySource: 'Podľa zdroja',
    bySourceNote: 'Routa API alebo artisan príkaz, ktorý volanie spustil.',
    byUser: 'Podľa používateľa',
    noCanal: 'Bez kanála',
    noUser: 'Systém (import, plánovač)',
    recent: 'Posledné volania',
    colWhen: 'Kedy',
    colFeature: 'Operácia',
    colContext: 'Kanál / používateľ',
    colTokens: 'Tokeny (vstup / výstup)',
    colCost: 'Cena',
    colName: 'Názov',
    colCalls: 'Volania',
    priceNote: 'Cena je odhad z počtu tokenov a cenníka v config/openai.php. Skutočné čerpanie a zostatok kreditu:',
    feature: {
      event_detection: 'Detekcia podujatia z textu',
      poster_detection: 'Detekcia z plagátu',
      copywriter: 'Prepis popisu (copywriter)',
      html_format: 'Formátovanie do HTML',
      text_edit: 'Úprava textu (AI asistent)',
      tags: 'Štítkovanie podujatí',
  ...
  users: {
    ...
    // Odkiaľ účet vznikol (users.registered_via). „ticket“ a „message“ nie sú
    // spôsoby prihlásenia — účet sa založil sám pri objednávke či správe.
    providers: {
      local: 'E-mailom',
      email: 'E-mailom',
      google: 'Google',
      facebook: 'Facebook',
      ticket: 'Objednávkou lístka',
      message: 'Odoslaním správy',
    },
    roles: {
      superAdmin: 'Super admin',
      admin: 'Administrátor',
  ...
  admin: {
    ...
    tools: {
      ...
      duplicatesTitle: 'Duplicitné podujatia',
      duplicatesLead: '— nájde tú istú akciu naimportovanú dvakrát (rovnaký názov, čas aj miesto).',
      duplicatesApply: 'Zlúčiť nájdené dvojice (zahodený záznam ide do koša)',
      duplicatesRun: 'Vypísať duplicity',
      duplicatesMerge: 'Zlúčiť duplicity',
      duplicatesNone: 'Žiadne duplicity.',
    ...
    user: {
      ...
      rolesRequired: 'Účet musí mať aspoň jednu rolu.',
      saving: 'Ukladám…',
      ...
      removeFailed: 'Zmazanie zlyhalo.',
      // Detail vs. formulár: detail je na čítanie, meniť sa dá v „Upraviť“.
      view: 'Zobraziť',
      edit: 'Upraviť',
      editTitle: 'Úprava používateľa',
      editLead: 'Prihlasovacie údaje, prístup a stav účtu.',
      backToDetail: '← Späť na detail',
      account: 'Účet',
      emailHint: 'Zmena adresy sama o sebe overenie nezruší — odškrtni ho nižšie.',
      emailVerified: 'E-mail je overený',
      emailVerifiedHint: 'Odškrtnutím sa overenie zruší a bude sa vyžadovať znova.',
      status: 'Stav účtu',
      password: 'Nové heslo',
      passwordHint: 'Prázdne = heslo sa nemení. Najmenej 8 znakov.',
      personalCanal: 'Osobný kanál',
      personalCanalHint: 'Vo svojom osobnom kanáli je používateľ vždy vlastníkom.',
      personalCanalNone: 'Bez osobného kanála',
      // Údaje, ktoré sa nedajú prepísať — sú záznamom o tom, čo sa stalo.
      readonly: 'Záznam o účte',
      readonlyHint: 'Údaje zapisuje systém, meniť sa nedajú.',
      id: 'ID',
      uuid: 'UUID',
      updatedAt: 'Naposledy zmenený',
      blockedAt: 'Blokovaný od',
      save: 'Uložiť zmeny',
      cancel: 'Zrušiť',
      saved: 'Zmeny uložené.',
      saveFailed: 'Uloženie zlyhalo.',
      selfEdit: 'Vlastný účet si tu upraviť nemôžeš — použi svoj profil.',
      deletedNote: 'Účet je zmazaný. Kým ho neobnovíš, zmeny sa neuložia.',
    },
  },
  ...
  filters: {
    ...
    attendees: {
      ...
      typeTitle: 'Typ lístka',
      allTypes: 'Všetky typy lístkov',
      checkinTitle: 'Vstup',
      allCheckin: 'Vstup: všetci',
      checkinArrived: 'Už prišli',
