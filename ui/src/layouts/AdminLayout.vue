  ...
  <div class="layout-shell admin-layout" :class="{ collapsed }">
    <aside class="aside">
      ...
      <nav class="aside-nav">
        ...
        <RouterLink to="/admin/ai-spotreba" class="aside-link" :class="{ active: inSection('/admin/ai-spotreba') }" :title="collapsed ? t('nav.aiUsage') : undefined">
          <svg class="nav-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M12 3l1.8 4.9L19 9.7l-5.2 1.8L12 16.4l-1.8-4.9L5 9.7l5.2-1.8zM19 15l.8 2.2L22 18l-2.2.8L19 21l-.8-2.2L16 18l2.2-.8z"/></svg>
          <span class="nav-label">{{ t('nav.aiUsage') }}</span>
        </RouterLink>
        <RouterLink to="/admin/dennik" class="aside-link" :class="{ active: inSection('/admin/dennik') }" :title="collapsed ? t('nav.systemLog') : undefined">
          <svg class="nav-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M6 3h9l4 4v14H6zM14 3v5h5M9 12h7M9 15.5h7M9 19h4"/></svg>
          <span class="nav-label">{{ t('nav.systemLog') }}</span>
        </RouterLink>
