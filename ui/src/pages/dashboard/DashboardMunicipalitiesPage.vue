<template>
  <div class="grid gap-4">
    ...
    <!-- Obce sú číselník: API pre ne nemá zápisové operácie
         (DashboardMunicipalityController pozná len index/all/show/destroy),
         takže zakladanie ani úprava sa tu neponúkajú — tlačidlá by skončili
         chybou servera. Zoznam sa plní importom, ostáva len zmazanie. -->
