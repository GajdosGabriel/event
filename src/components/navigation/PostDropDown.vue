...
export default {
  setup() {
    const { open, toggleHandle } = useClickAway();

    return { open, toggleHandle };
  },
...
<template>
  <div>
    ...
    <!-- </router-link> -->
    <div
      class="bg-white text-base z-10 list-none divide-y divide-gray-100 rounded shadow w-44 absolute"
      v-if="open"
    >
